  ...
  return (
    <AuthLayout title="Sign Up Free" isSignUp={true}>
      <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
        ...
        {/* SSO Social Login Grid */}
        <div className="grid grid-cols-4 gap-3 pt-2">
          {/* SSO Button */}
          <div className="flex flex-col items-center">
            <button className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center hover:bg-slate-200 transition mb-1">
              <svg className="w-5 h-5 text-slate-800" fill="currentColor" viewBox="0 0 24 24">
                <path d="M7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm0-6c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4zm12.5 2H18v-1c0-1.7-1.3-3-3-3h-1V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H5c-1.7 0-3 1.3-3 3v8c0 1.7 1.3 3 3 3h14c1.7 0 3-1.3 3-3v-5c0-1.7-1.3-3-2.5-3z" />
              </svg>
            </button>
            <span className="text-xs text-slate-600">SSO</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            <button className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center hover:bg-slate-200 transition mb-1">
              <svg className="w-5 h-5 text-slate-800" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.32c.67-.82 1.12-1.96.99-3.1-.97.04-2.15.65-2.85 1.47-.62.72-1.16 1.88-1.02 3 1.09.08 2.21-.55 2.88-1.37z" />
              </svg>
            </button>
            <span className="text-xs text-slate-600">Apple</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-slate-800 font-semibold">Facebook</span>
          </div>
        </div>
